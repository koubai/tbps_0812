...
<script type="text/javascript">
	function upd() {
		...
		document.mainform.action = '<c:url value="/withhold/updWithholdAction.action"></c:url>';
	...
	window.onunload = function() {
		//刷新父页面
		window.dialogArguments.document.mainform.action = '<c:url value="/withhold/turnWithholdAction.action"></c:url>';
...
<s:form id="mainform" name="mainform" method="POST">
	<s:hidden name="updWithhold.WITHHOLD_DATE" id="WITHHOLD_DATE"></s:hidden>
	<s:hidden name="updWithhold.WITHHOLD_NO" id="WITHHOLD_NO"></s:hidden>
		...
		<table style="margin-left: 50px; margin-top: 30px;" border="0" cellspacing="15" cellpadding="0">
			<tr>
				...
				<td colspan="3">
					...
					<div class="box1_center">
						<input type="text" style="width:300px;" disabled="disabled" maxlength="10" value="<s:property value="updWithhold.WITHHOLD_NO"/>"/>
					</div>
			...
			<tr>
				...
				<td colspan="3">
					<div class="box1_left"></div>
					<div class="box1_center">
						<select style="width: 300px;" name="updWithhold.WITHHOLD_TYPE" id="RANK">
							<s:if test='updWithhold.WITHHOLD_TYPE == "G"'>
							...
							<s:elseif test='updWithhold.WITHHOLD_TYPE == "B"'>
							...
							<s:elseif test='updWithhold.WITHHOLD_TYPE == "F"'>
								<option value="G">工资</option>
								<option value="B">办公费</option>
							...
							<s:elseif test='updWithhold.WITHHOLD_TYPE == "D"'>
								<option value="G">工资</option>
								<option value="B">办公费</option>
								<option value="F">房租</option>
							...
							<s:elseif test='updWithhold.WITHHOLD_TYPE == "Q"'>
								<option value="G">工资</option>
								<option value="B">办公费</option>
								<option value="F">房租</option>
								<option value="D">电费</option>
			...
			<tr>
				...
				<td colspan="3">
					...
					<div class="box1_center date_input">
						<input type="text" id="withholdDate" style="width:285px;" disabled="disabled" value="<s:date name="updWithhold.WITHHOLD_DATE" format="yyyy-MM-dd" />"/>
			...
			<tr>
				...
				<td colspan="3">
					<div class="box1_left"></div>
					<div class="box1_center">
						<s:textfield name="updWithhold.WITHHOLD_AMOUNT" id="WITHHOLD_AMOUNT" cssStyle="width:300px;" maxlength="12" theme="simple"></s:textfield>
					</div>
					<div class="box1_right"></div>
				</td>
			</tr>
			<tr>
				...
				<td colspan="3">
					<div class="box1_left"></div>
					<div class="box1_center">
						<s:textfield name="updWithhold.WITHHOLD_REASON" id="WITHHOLD_REASON" cssStyle="width:300px;" maxlength="60" theme="simple"></s:textfield>
					</div>
					<div class="box1_right"></div>
				</td>
			</tr>
