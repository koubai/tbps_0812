						...
						<div class="col-lg-12">
							<div class="box">
								...
								<div class="row">
									...
									<div class="col-lg-8">
										<s:textfield name="addAgentCompDto.RESERVE4" id="RESERVE4" cssClass="form-control" maxlength="40" theme="simple"></s:textfield>
									</div>
								</div>
								<div class="row">
									<label class="col-lg-2 form-label">电话</label>
									<div class="col-lg-8">
										<s:textfield name="addAgentCompDto.RESERVE5" id="RESERVE5" cssClass="form-control" maxlength="40" theme="simple"></s:textfield>
									</div>
								</div>
								<div class="row">
