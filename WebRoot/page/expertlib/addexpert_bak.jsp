...
<script type="text/javascript">
	function add() {
		...
		if(EXPERT_MAJOR == "00000000000000000000000000000000000") {
			alert("请选择专业不能为空！");
			$("#architect").focus();
			return;
		}
		...
		<table border="0" cellspacing="15" cellpadding="0" style="margin:20px auto">
			...
			<tr>
				...
				<td colspan="3" class="lab15">
					<s:if test='%{addExpertLibDto.EXPERT_MAJOR.substring(0, 1) == "1"}'>
