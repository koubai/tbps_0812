						...
						<div class="col-lg-12">
							<div class="box">
								...
								<div class="row">
									...
									<div class="col-lg-4">
										<s:textfield name="addExpertLibDto.EXPERT_NAME" id="EXPERT_NAME" cssClass="form-control" maxlength="24" theme="simple"></s:textfield>
									</div>
								...
								<div class="row">
									...
									<div class="col-lg-4">
										<div class="input-group date" data-provide="datepicker">
											<input id="tmpEXPERT_BIRTH" value="<s:date name="addExpertLibDto.EXPERT_BIRTH" format="yyyy-MM-dd"/>" maxlength="10" type="text" class="form-control datepicker" readonly>
									...
									<div class="col-lg-4">
										<s:textfield name="addExpertLibDto.EXPERT_TEL1" id="EXPERT_TEL1" cssClass="form-control" maxlength="14" theme="simple"></s:textfield>
									</div>
								</div>
								<div class="row">
									<label class="col-lg-2 form-label">固话</label>
									<div class="col-lg-4">
										<s:textfield name="addExpertLibDto.EXPERT_TEL2" id="EXPERT_TEL2" cssClass="form-control" maxlength="14" theme="simple"></s:textfield>
									</div>
									<label class="col-lg-2 form-label">就职公司</label>
									<div class="col-lg-4">
										<s:textfield name="addExpertLibDto.EXPERT_COMP" id="EXPERT_COMP" cssClass="form-control" maxlength="40" theme="simple"></s:textfield>
									</div>
								</div>
								<div class="row">
								...
								<div class="row">
									...
									<div class="col-lg-4">
										<s:textfield name="addExpertLibDto.EXPERT_QULI" id="EXPERT_QULI" cssClass="form-control" maxlength="40" theme="simple"></s:textfield>
									</div>
								</div>
								<div class="row">
									<label class="col-lg-2 form-label">备注</label>
									<div class="col-lg-8">
										<textarea name="" id="tmpMEMO1" cols="" rows="5" class="form-control"><s:property value="addExpertLibDto.MEMO1"/></textarea>
									</div>
								</div>
							</div>
						</div>
