...
<script type="text/javascript">
	...
	function addBidComp() {
		...
		projectmanager = projectmanager.substring(0, projectmanager.length - 2);
		//工程师
		window.dialogArguments.document.getElementById("projectManager").value = projectmanager;
		window.close();
	}
</script>
</head>
		...
		<div class="data_table" style="padding:0px;">
			...
			<div class="tab_content">
				<table class="info_tab" width="100%" border="1" cellpadding="5" cellspacing="0">
					...
					<s:iterator id="listProjectMg" value="listProjectMg" var="projectMg" status="st1">
						...
						<s:else>
							...
							<td><input name="checkKey" type="checkbox" value="<s:property value="PROJECT_MANAGER"/>"/></td>
