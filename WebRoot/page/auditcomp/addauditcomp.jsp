...
<script type="text/javascript">
	function add() {
		...
		var AUDIT_COMP_CLIENTID = $("#AUDIT_COMP_CLIENTID").val().trim();
		...
		document.mainform.action = '<c:url value="/auditcomp/addAuditCompAction.action"></c:url>';
...
<s:form id="mainform" name="mainform" method="POST">
	<s:hidden name="addAuditCompDto.AUDIT_COMP_CLIENTID" id="AUDIT_COMP_CLIENTID"></s:hidden>
		...
		<table style="margin-left: 50px; margin-top: 30px;" border="0" cellspacing="15" cellpadding="0">
			<tr>
				...
				<td width="500">
					...
					<div class="box1_center">
						<s:textfield name="addAuditCompDto.AUDIT_COMP_NO" id="AUDIT_COMP_NO" cssStyle="width:350px;" maxlength="20" theme="simple"></s:textfield>
					</div>
			...
			<tr>
				...
				<td>
					<div class="box1_left"></div>
					<div class="box1_center">
						<s:textfield name="addAuditCompDto.AUDIT_COMP_NAME" id="AUDIT_COMP_NAME" cssStyle="width:350px;" maxlength="40" theme="simple"></s:textfield>
					</div>
					<div class="box1_right"></div>
				</td>
			</tr>
			<tr>
				...
				<td>
					<div class="box1_left"></div>
					<div class="box1_center">
						<s:textfield name="addAuditCompDto.AUDIT_COMP_CLIENT" id="AUDIT_COMP_CLIENT" cssStyle="width:350px;" maxlength="40" theme="simple"></s:textfield>
					</div>
					<div class="box1_right"></div>
					<div class="btn">
						<div class="box1_left"></div>
