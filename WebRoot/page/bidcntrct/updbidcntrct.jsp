				...
				<div class="container-fluid">
					...
					<div class="row mgt15">
						...
						<div class="col-lg-3 form-group">
							...
							<div class="col-lg-9">
								<select name="updBidCntrctDto.CNTRCT_TYPE" id="CNTRCT_TYPE" class="form-control" onchange="changeCNTRCT_TYPE(this);">
									...
									<s:elseif test='updBidCntrctDto.CNTRCT_TYPE == "5"'>
									...
									<s:elseif test='updBidCntrctDto.CNTRCT_TYPE == "6"'>
										<option value="1">招标</option>
										<option value="5">电子招标</option>
									...
									<s:elseif test='updBidCntrctDto.CNTRCT_TYPE == "7"'>
										<option value="1">招标</option>
										<option value="5">电子招标</option>
										<option value="6">核价竞价</option>
									...
									<s:elseif test='updBidCntrctDto.CNTRCT_TYPE == "9"'>
										<option value="1">招标</option>
										<option value="5">电子招标</option>
										<option value="6">核价竞价</option>
										<option value="7">公开竞价</option>
						...
						<s:if test='updBidCntrctDto.CNTRCT_TYPE == "9"'>
						...
						<div id="divRESERVE1" class="col-lg-3 form-group" style="display: none;">
							...
							<div class="col-lg-9">
								<s:textfield name="updBidCntrctDto.RESERVE1" id="RESERVE1" maxlength="10" cssClass="form-control" theme="simple"></s:textfield>
							</div>
						</div>
