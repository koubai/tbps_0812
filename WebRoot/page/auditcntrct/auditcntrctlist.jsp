...
<script type="text/javascript">
	...
	function setQueryDate() {
		$("#strCntrctStDateLow").attr("value", $("#cntrctStDateLow").val());
		$("#strCntrctStDateHigh").attr("value", $("#cntrctStDateHigh").val());
	}
		...
		<div class="row">
			...
			<div class="col-lg-10 right">
				...
				<s:form id="mainform" name="mainform" method="POST">
					...
					<s:hidden name="strCntrctStDateLow" id="strCntrctStDateLow"/>
					<s:hidden name="strCntrctStDateHigh" id="strCntrctStDateHigh"/>
					...
					<div class="row">
						...
						<div class="col-lg-12 form-group">
							...
							<div class="col-lg-2">
								<div class="input-group date" data-provide="datepicker">
									<input type="text" class="form-control datepicker" readonly id="cntrctStDateLow" value="<s:property value="strCntrctStDateLow"/>" maxlength="10" />
							...
							<div class="col-lg-2">
								<div class="input-group date" data-provide="datepicker">
									<input type="text" class="form-control datepicker" readonly id="cntrctStDateHigh" value="<s:property value="strCntrctStDateHigh"/>" maxlength="10" />
									<div class="input-group-addon">
										<span class="glyphicon glyphicon-th"></span>
									</div>
								</div>
						...
						<div class="col-lg-12 form-group">
							...
							<div class="col-lg-1">
								<button class="btn btn-success" type="button" onclick="del();">删除</button>
							</div>
						 	<div class="col-lg-1"></div>
							<div class="col-lg-1">
								<button class="btn btn-success" type="button" onclick="add();">增加</button>
							</div>
							<div class="col-lg-1">
								<button class="btn btn-success" type="button" onclick="upd();">编辑</button>
							</div>
						</div>
					</div>
