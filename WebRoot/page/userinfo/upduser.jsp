						...
						<div class="col-lg-12">
							<div class="box">
								...
								<div class="row">
									...
									<div class="col-lg-8">
										<s:textfield name="updUserInfoDto.LOGIN_ID" disabled="true" id="LOGIN_ID" cssClass="form-control" maxlength="4" theme="simple"></s:textfield>
									</div>
								</div>
								<div class="row">
									<label class="col-lg-2 form-label">登录姓名</label>
									<div class="col-lg-8">
										<s:textfield name="updUserInfoDto.LOGIN_NAME" id="LOGIN_NAME" cssClass="form-control" maxlength="10" theme="simple"></s:textfield>
									</div>
								</div>
								<div class="row">
									<label class="col-lg-2 form-label">登录密码</label>
									<div class="col-lg-8">
										<s:password name="updUserInfoDto.LOGIN_PW" id="LOGIN_PW" cssClass="form-control" maxlength="16" theme="simple"></s:password>
									</div>
								</div>
								<div class="row">
									<label class="col-lg-2 form-label">确认密码</label>
									<div class="col-lg-8">
										<s:password name="updUserInfoDto.CONFIRM_PW" id="CONFIRM_PW" cssClass="form-control" maxlength="16" theme="simple"></s:password>
									</div>
								</div>
								<div class="row">
									<label class="col-lg-2 form-label">用户类型</label>
									<div class="col-lg-8">
										<select name="updUserInfoDto.RANK" id="RANK" class="form-control">
								...
								<div class="row">
									...
									<div class="col-lg-8">
										<textarea name="" id="tmpMEMO1" cols="" rows="5" class="form-control"><s:property value="updUserInfoDto.MEMO1"/></textarea>
									</div>
								</div>
							</div>
						</div>
