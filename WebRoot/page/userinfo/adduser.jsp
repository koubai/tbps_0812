		...
		<table style="margin-left: 50px; margin-top: 30px;" border="0" cellspacing="15" cellpadding="0">
			<tr>
				...
				<td>
					...
					<div class="box1_center">
						<s:textfield name="addUserInfoDto.LOGIN_ID" id="LOGIN_ID" cssStyle="width:300px;" maxlength="4" theme="simple"></s:textfield>
					</div>
			...
			<tr>
				...
				<td>
					<div class="box1_left"></div>
					<div class="box1_center">
						<s:textfield name="addUserInfoDto.LOGIN_NAME" id="LOGIN_NAME" cssStyle="width:300px;" maxlength="10" theme="simple"></s:textfield>
					</div>
					<div class="box1_right"></div>
				</td>
			</tr>
			<tr>
				...
				<td>
					<div class="box1_left"></div>
					<div class="box1_center">
						<s:password name="addUserInfoDto.LOGIN_PW" id="LOGIN_PW" cssStyle="width:300px;" theme="simple" maxlength="16"></s:password>
					</div>
					<div class="box1_right"></div>
				</td>
			</tr>
			<tr>
				...
				<td>
					<div class="box1_left"></div>
					<div class="box1_center">
						<s:password name="addUserInfoDto.CONFIRM_PW" id="CONFIRM_PW" cssStyle="width:300px;" theme="simple" maxlength="16"></s:password>
					</div>
					<div class="box1_right"></div>
				</td>
			</tr>
			<tr>
				...
				<td>
					<div class="box1_left"></div>
					<div class="box1_center">
						<select style="width: 300px;" name="addUserInfoDto.RANK" id="RANK">
			...
			<tr>
				<td>备注</td>
				<td>
					<textarea name="" id="tmpMEMO1" cols="" rows="5" style="width:300px;"><s:property value="addUserInfoDto.MEMO1"/></textarea>
				</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
