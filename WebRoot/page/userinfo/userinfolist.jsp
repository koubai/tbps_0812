...
<script type="text/javascript">
	...
	function add() {
		var url = '<c:url value="/userinfo/showAddUserInfoAction.action"></c:url>' + "?date=" + new Date();
	...
	function upd() {
		...
		if(id == "") {
			...
			var url = '<c:url value="/userinfo/showUpdUserInfoAction.action"></c:url>'
					+ "?updLoginId=" + id
					+ "&date=" + new Date();
			window.showModalDialog(url, window, "dialogheight:460px;dialogwidth:550px;center:yes;status:0;resizable=no;Minimize=no;Maximize=no");
		}
				...
				<div class="searchbox">
					<div class="box1">
						...
						<div class="box1_center">
							<s:textfield name="strLoginName" id="strLoginName" cssStyle="width:135px;" maxlength="10" theme="simple"></s:textfield>
						</div>
					...
					<div class="box1" style="margin-top:-3px; margin-left: -340px; color: red;">
						<s:actionmessage />
					</div>
