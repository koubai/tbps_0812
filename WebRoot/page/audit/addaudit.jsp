				...
				<s:form id="mainform" name="mainform" method="POST">
					...
					<div class="row">
						<div class="col-lg-12 form-group">
							...
							<div class="col-lg-1">
								<button class="btn btn-success form-control" type="button" id="cntrct_sel"  onclick="showCntrSelect();">合同选择</button>
							</div>
						...
						<div class="col-lg-12 form-group" id="pricetype">
							...
							<div id="AimPriceDiv">
								...
								<div class="col-lg-2">
									<s:textfield name="addAuditDto.RESERVE8" id="RESERVE8" cssClass="col-lg-10 form-control" maxlength="14" theme="simple"></s:textfield>
								</div>
							</div>
						</div>
