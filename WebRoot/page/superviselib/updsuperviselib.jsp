...
<script type="text/javascript">
	function upd() {
		...
		if(confirm("确定修改吗？")) {
			document.mainform.action = '<c:url value="/superviselib/updSuperviseLibAction.action"></c:url>';
...
<body>
	...
	<div class="container-fluid">
		...
		<s:form id="mainform" name="mainform" method="POST">
			<s:hidden name="updSuperviseLibDto.MEMO1" id="MEMO1"></s:hidden>
			<div class="row">
				<div class="container-fluid">
						...
						<div class="col-lg-12">
							<div class="box">
								...
								<div class="row">
									...
									<div class="col-lg-8">
										<s:textfield name="updSuperviseLibDto.SUPERVISE_NAME" id="SUPERVISE_NAME" cssClass="form-control" maxlength="8" theme="simple"></s:textfield>
									</div>
								</div>
								<div class="row">
									<label class="col-lg-2 form-label">联系电话</label>
									<div class="col-lg-8">
										<s:textfield name="updSuperviseLibDto.SUPERVISE_TEL1" id="SUPERVISE_TEL1" cssClass="form-control" maxlength="12" theme="simple"></s:textfield>
									</div>
								</div>
								<div class="row">
									<label class="col-lg-2 form-label">性别</label>
									<div class="col-lg-8">
										<select name="updSuperviseLibDto.SUPERVISE_GENDER" id="SUPERVISE_GENDER" class="form-control">
											<option value="">请选择</option>
											<s:if test='updSuperviseLibDto.SUPERVISE_GENDER == "1"'>
												<option value="1" selected="selected">男</option>
												<option value="2">女</option>
											</s:if>
											<s:elseif test='updSuperviseLibDto.SUPERVISE_GENDER == "2"'>
								...
								<div class="row">
									...
									<div class="col-lg-8">
										<s:textfield name="updSuperviseLibDto.SUPERVISE_COMP" id="SUPERVISE_COMP" cssClass="form-control" maxlength="40" theme="simple"></s:textfield>
									</div>
								</div>
								<div class="row">
									<label class="col-lg-2 form-label">备注</label>
									<div class="col-lg-8">
										<textarea name="" id="tmpMEMO1" cols="" rows="5" class="form-control"><s:property value="updSuperviseLibDto.MEMO1"/></textarea>
									</div>
								</div>
							</div>
						</div>
