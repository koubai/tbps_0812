...
public class StringUtil {
	 ...
	 * @return
	 */
	public static boolean isJJ(String zbno) {
		if(StringUtil.isBlank(zbno)) {
			return false;
		}
		String regex = "^LHJJ\\-[0-9]{2}\\-[0-9]{3}$";
		return zbno.matches(regex);
	}
	 ...
	 * @return
	 */
	public static boolean isQT(String zbno) {
		if(StringUtil.isBlank(zbno)) {
			return false;
		}
		String regex = "^LHQT\\-[0-9]{2}\\-[0-9]{3}$";
		return zbno.matches(regex);
	}
	 ...
	 * @return
	 */
	public static String createFileName3(String pre) {
		String name = null;
		Date date = new Date();
		SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMddHHmmss");
		name = sdf.format(date);
...
//		System.out.println(replenishStr("1111", 0));
		...
		System.out.println(isNumeric("11.23"));
		System.out.println(isNumeric("avb1111"));
		System.out.println(isNumeric("11.2.3"));
	}
