...
//			cell6.setCellValue(biddata.getBID_AGENT_PAY());
			...
			// 保证金金额（万元）
			cell7.setCellValue(StringUtil.BigDecimal2Str(biddata.getBID_BOND(), 6));
			cell7.setCellStyle(style);
			// 投标单位
			cell8.setCellValue(biddata.getBID_CO_NAME());
			cell8.setCellStyle(style);
			// 投标价（万元）
			cell9.setCellValue((StringUtil.BigDecimal2Str(biddata.getBID_PRICE(),6)));
			cell9.setCellStyle(style);
			// 中标单位
			if (biddata.getBID_RESULT() != null && biddata.getBID_RESULT().equals("1"))
				cell10.setCellValue(biddata.getBID_CO_NAME());
			else 
				cell10.setCellValue("");			
			cell10.setCellStyle(style);
			// 中标价（万元）
			if (biddata.getBID_RESULT() != null && biddata.getBID_RESULT().equals("1"))
				cell11.setCellValue(StringUtil.BigDecimal2Str(biddata.getBID_WIN_PRICE(),6));
			else 
				cell11.setCellValue("");			
			cell11.setCellStyle(style);
			// 标书费
			cell12.setCellValue(StringUtil.BigDecimal2Str(biddata.getBID_APPLY_PRICE(),2));
			cell12.setCellStyle(style);
			// 应收代理费（万元）
			cell13.setCellValue(StringUtil.BigDecimal2Str(biddata.getBID_AGENT_PRICE(),6));
			cell13.setCellStyle(style);
			// 实收代理费（万元）
			cell14.setCellValue(StringUtil.BigDecimal2Str(biddata.getBID_AGENT_PRICE_ACT(),6));
			cell14.setCellStyle(style);
			// 工程师
			cell15.setCellValue(biddata.getPROJECT_MANAGER_NAME());
			cell15.setCellStyle(style);
			// 开标时间
			if (biddata.getTENDER_OPEN_DATE() != null)
				cell16.setCellValue(format0.format(biddata.getTENDER_OPEN_DATE()));
			else
				cell16.setCellValue("");
...
//			cell16.setCellValue(biddata.getBID_EXPERT_COMMISION_PRE_DATE().toString());
			if (biddata.getBID_EXPERT_COMMISION_APPLY_DATE()!= null)
				cell17.setCellValue(format0.format(biddata.getBID_EXPERT_COMMISION_APPLY_DATE()));
			else
				cell17.setCellValue("");
			cell17.setCellStyle(style);
			// 专家费预借费用
			cell18.setCellValue(StringUtil.BigDecimal2Str(biddata.getBID_EXPERT_COMMISION_PRE_YUAN_SHOW(),2));
			cell18.setCellStyle(style);
			// 专家费实际费用
			cell19.setCellValue(StringUtil.BigDecimal2Str(biddata.getBID_EXPERT_COMMISION_ACT_YUAN_SHOW(),2));
			cell19.setCellStyle(style);			
			// 专家费差价退还日期
			if (biddata.getBID_EXPERT_COMMISION_DIFF_DATE()!=null)
				cell20.setCellValue(format0.format(biddata.getBID_EXPERT_COMMISION_DIFF_DATE()));
			else
				cell20.setCellValue("");
			cell20.setCellStyle(style);			
			// 保证金支付形式
			if (biddata.getBID_PAYMENT_TYPE()== null)
				cell21.setCellValue(biddata.getBID_PAYMENT_TYPE());				
			else {
				if (biddata.getBID_PAYMENT_TYPE().equals("1"))
					cell21.setCellValue("现金");
				if (biddata.getBID_PAYMENT_TYPE().equals("2"))
					cell21.setCellValue("支票");
				if (biddata.getBID_PAYMENT_TYPE().equals("3"))
					cell21.setCellValue("转账");
				if (biddata.getBID_PAYMENT_TYPE().equals("4"))
					cell21.setCellValue("汇票");
				if (biddata.getBID_PAYMENT_TYPE().equals("5"))
					cell21.setCellValue("保函");
				if (biddata.getBID_PAYMENT_TYPE().equals("6"))
					cell21.setCellValue("现金2");				
			}
//			cell21.setCellValue(biddata.getBID_PAYMENT_TYPE());
			cell21.setCellStyle(style);			
			// 保证金入账日期
			if (biddata.getBID_VALUE_DATE()!=null)
				cell22.setCellValue(format0.format(biddata.getBID_VALUE_DATE()));
			else
				cell22.setCellValue("");
			cell22.setCellStyle(style);			
			// 保证金退还日期
			if (biddata.getREFOUND_DEPOSIT_DATE()!= null)
				cell23.setCellValue(format0.format(biddata.getREFOUND_DEPOSIT_DATE()));
			else
				cell23.setCellValue("");
			cell23.setCellStyle(style);			
			// 标书费入账日期
			if (biddata.getBID_APPLY_PRICE_DATE()!=null)
				cell24.setCellValue(format0.format(biddata.getBID_APPLY_PRICE_DATE()));
			else
				cell24.setCellValue("");
			cell24.setCellStyle(style);			
			// 标书费开票形式
			if (biddata.getINVOICE_TYPE() == null)
				cell25.setCellValue(biddata.getINVOICE_TYPE());
			else {
				if (biddata.getINVOICE_TYPE().equals("0"))
					cell25.setCellValue("未支付");
				if (biddata.getINVOICE_TYPE().equals("1"))
					cell25.setCellValue("现金");
				if (biddata.getINVOICE_TYPE().equals("3"))
					cell25.setCellValue("转账");								
			}
//			cell25.setCellValue(biddata.getINVOICE_TYPE());
			cell25.setCellStyle(style);			
			// 标书费开票日期
			if (biddata.getINVOICE_DATE()!= null)
				cell26.setCellValue(format0.format(biddata.getINVOICE_DATE()));
			else
				cell26.setCellValue("");
			cell26.setCellStyle(style);			
			// 标书费发票编号
			cell27.setCellValue(biddata.getBID_RECEIPT_NO());
			cell27.setCellStyle(style);			
			// 代理费开票日期
			if (biddata.getRECEIPT1_DATE()!= null)
				cell28.setCellValue(format0.format(biddata.getRECEIPT1_DATE()));
			else 
				cell28.setCellValue("");
			cell28.setCellStyle(style);			
			// 代理费发票编号
			cell29.setCellValue(biddata.getBID_AGENT_PRICE_INVOICE());
			cell29.setCellStyle(style);			
			// 代理费入账日期
			if (biddata.getRECEIPT1_VALUE_DATE()!= null)
				cell30.setCellValue(format0.format(biddata.getRECEIPT1_VALUE_DATE()));
			else
				cell30.setCellValue("");
