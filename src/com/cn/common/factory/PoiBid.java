...
public class PoiBid extends Poi2007Base {
	...
	public void writeData(XSSFSheet sheet, XSSFWorkbook workbook) {
		...
		for(int i = 0; i < datas.size(); i++) {
			...
			XSSFCell cell85 = row.createCell(85);
			...
			cell40.setCellValue(StringUtil.BigDecimal2Str(bid.getBID_APPLY_PRICE_TOTPAID(), 2));
			cell40.setCellStyle(style);
			cell41.setCellValue(bid.getBID_EXPERT_COMMISION_APPLY_NAME());
			cell41.setCellStyle(style);
			cell42.setCellValue(DateUtil.dateToStr(bid.getBID_EXPERT_COMMISION_APPLY_DATE(), format));
			cell42.setCellStyle(style);
			cell43.setCellValue(DateUtil.dateToStr(bid.getAPPLY_FORM_EDIT_DATE(), format));
			cell43.setCellStyle(style);
			cell44.setCellValue(DateUtil.dateToStr(bid.getAPPLY_FORM_COLLECT_DATE(), format));
			cell44.setCellStyle(style);
			cell45.setCellValue(DateUtil.dateToStr(bid.getAPPLY_FORM_VERIFY_DATE(), format));
			cell45.setCellStyle(style);
			cell46.setCellValue(bid.getAPPLY_FORM_VERIFY());
			cell46.setCellStyle(style);
			cell47.setCellValue(DateUtil.dateToStr(bid.getAPPLY_FORM_FIX_DATE(), format));
			cell47.setCellStyle(style);
			cell48.setCellValue(DateUtil.dateToStr(bid.getAPPLY_FORM_BOX_DATE(), format));
			cell48.setCellStyle(style);
			cell49.setCellValue(DateUtil.dateToStr(bid.getSUPPORT_DOC_DATE(), format));
			cell49.setCellStyle(style);
			cell50.setCellValue(DateUtil.dateToStr(bid.getBID_NOTICE_ST_DATE(), format));
			cell50.setCellStyle(style);
			cell51.setCellValue(DateUtil.dateToStr(bid.getBID_NOTICE_ED_DATE(), format));
			cell51.setCellStyle(style);
			cell52.setCellValue(DateUtil.dateToStr(bid.getBID_MESSAGE_DATE(), format));
			cell52.setCellStyle(style);
			cell53.setCellValue(DateUtil.dateToStr(bid.getBID_DOC_DELI_DATE1(), format));
			cell53.setCellStyle(style);
			cell54.setCellValue(bid.getBID_DOC_DELI_FILE1());
			cell54.setCellStyle(style);
			cell55.setCellValue(DateUtil.dateToStr(bid.getBID_DOC_DELI_DATE2(), format));
			cell55.setCellStyle(style);
			cell56.setCellValue(bid.getBID_DOC_DELI_FILE2());
			cell56.setCellStyle(style);
			cell57.setCellValue(DateUtil.dateToStr(bid.getBID_DOC_DELI_DATE3(), format));
			cell57.setCellStyle(style);
			cell58.setCellValue(bid.getBID_DOC_DELI_FILE3());
			cell58.setCellStyle(style);
			cell59.setCellValue(DateUtil.dateToStr(bid.getBID_DOC_DELI_DATE4(), format));
			cell59.setCellStyle(style);
			cell60.setCellValue(bid.getBID_DOC_DELI_FILE4());
			cell60.setCellStyle(style);
			cell61.setCellValue(DateUtil.dateToStr(bid.getBID_DOC_DELI_DATE5(), format));
			cell61.setCellStyle(style);
			cell62.setCellValue(bid.getBID_DOC_DELI_FILE5());
			cell62.setCellStyle(style);
			cell63.setCellValue(DateUtil.dateToStr(bid.getBID_DOC_DELI_DATE6(), format));
			cell63.setCellStyle(style);
			cell64.setCellValue(bid.getBID_DOC_DELI_FILE6());
			cell64.setCellStyle(style);
			cell65.setCellValue(DateUtil.dateToStr(bid.getBID_DOC_DELI_DATE7(), format));
			cell65.setCellStyle(style);
			cell66.setCellValue(bid.getBID_DOC_DELI_FILE7());
			cell66.setCellStyle(style);
			cell67.setCellValue(DateUtil.dateToStr(bid.getBID_DOC_DELI_DATE8(), format));
			cell67.setCellStyle(style);
			cell68.setCellValue(bid.getBID_DOC_DELI_FILE8());
			cell68.setCellStyle(style);
			cell69.setCellValue(DateUtil.dateToStr(bid.getBID_DOC_DELI_DATE9(), format));
			cell69.setCellStyle(style);
			cell70.setCellValue(bid.getBID_DOC_DELI_FILE9());
			cell70.setCellStyle(style);
			cell71.setCellValue(DateUtil.dateToStr(bid.getBID_DOC_DELI_DATE10(), format));
			cell71.setCellStyle(style);
			cell72.setCellValue(bid.getBID_DOC_DELI_FILE10());
			cell72.setCellStyle(style);
			cell73.setCellValue(DateUtil.dateToStr(bid.getBID_INFORM_RCV_DATE(), format));
			cell73.setCellStyle(style);
			cell74.setCellValue(bid.getBID_INFORM_RCV());
			cell74.setCellStyle(style);
			cell75.setCellValue(DateUtil.dateToStr(bid.getBID_VER_DOC_SCAN_DATE(), format));
			cell75.setCellStyle(style);
			cell76.setCellValue(bid.getBID_VER_DOC_SCAN());
			cell76.setCellStyle(style);
			cell77.setCellValue(bid.getPROGRESS_STATUS_NAME());
			cell77.setCellStyle(style);
			cell78.setCellValue(bid.getFINISH_STATUS_NAME());
			cell78.setCellStyle(style);
			cell79.setCellValue(DateUtil.dateToStr(bid.getFINISH_DATE(), format));
			cell79.setCellStyle(style);
			cell80.setCellValue(bid.getFINISH_NOTE());
			cell80.setCellStyle(style);
			cell81.setCellValue(bid.getSTATUS_NAME());
			cell81.setCellStyle(style);
			cell82.setCellValue(bid.getMEMO1());
			cell82.setCellStyle(style);
			cell83.setCellValue(bid.getUPDATE_USER());
			cell83.setCellStyle(style);
			cell84.setCellValue(DateUtil.dateToStr(bid.getINSERT_DATE(), format));
			cell84.setCellStyle(style);
			cell85.setCellValue(DateUtil.dateToStr(bid.getUPDATE_DATE(), format));
