...
public class BidCntrctHisDto extends BaseDto {
	
	private static final long serialVersionUID = -3960961900449296110L;

	/**
	 * 履历主键
	 */
	private Integer BID_CNTRCT_HIS_SEQ;
	...
	public Integer getBID_CNTRCT_HIS_SEQ() {
		return BID_CNTRCT_HIS_SEQ;
	}
