...
public class AuditCntrctHisDto extends BaseDto {
	
	private static final long serialVersionUID = 1922269559550823722L;

	/**
	 * 主键
	 */
	private Integer CNTRCT_HIST_SEQ;
	...
	public void setCNTRCT_HIST_SEQ(Integer cNTRCT_HIST_SEQ) {
		CNTRCT_HIST_SEQ = cNTRCT_HIST_SEQ;
	}
