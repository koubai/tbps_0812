 ...
 * @version 1.0
 */
public class AuditHistDto extends BaseDto {
	...
	public Integer getAUDIT_HIS_SEQ() {
		return AUDIT_HIS_SEQ;
	}

	public void setAUDIT_HIS_SEQ(Integer aUDIT_HIS_SEQ) {
