...
/**
 * @name AgentCompService.java
 * @author Frank
 * @time 2013-10-15下午9:58:38
 * @version 1.0
 */
public interface AgentCompService {
	 ...
	 * @return
	 */
	public Page queryAgentCompByPage(Page page, String agentCompNoLow, String agentCompNoHigh, String agentAddFlag, String agentCompName);
